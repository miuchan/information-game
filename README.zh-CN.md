...
为明确最近一轮玩法调参，当前规则包含以下变化：

- **更强的私有真相信号反馈**：相较早期版本，私有信号到达率更高、准确率更高。
- **事实核查揭示推力**：在揭示轮中，一部分节点会获得额外真相方向推力。
- **短期证据记忆**：节点会在短窗口内累计私有证据；当证据足够强时，会暂时降低社交压力影响。
- **更陡峭的声誉实际影响曲线**：声誉可见性基线权重更低，但斜率更高；反复受罚节点影响力下降更快。
- **轻度怀疑/遗忘机制**：极端确信节点会以低概率回退一级信念，减少不可逆锁死。
...
在当前参数下，私有信号相较早期版本被有意增强（更高到达率与准确率），而事实核查揭示轮会向一部分节点额外注入真相方向推力。这让“现实反馈”足够持续，不至于被纯社交从众轻易淹没。
...
节点还保留一段短期证据记忆，用来累计私有真相压力。当累计证据足够强时，节点会暂时忽略社交压力，优先沿证据方向更新。
...
此外，声誉可见性在当前规则下具有更低基础权重但更陡峭的声誉斜率：被反复惩罚的节点会失去更多“实际影响力”。

系统还包含一个小幅怀疑/遗忘机制：极端确信的主体会以低概率回退一级信念，以减少不可逆锁死。
